      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="text-center mt-10">
            <a
              href="#contact"
              className="inline-block min-w-[250px] px-8 py-3 rounded-xl text-white font-semibold hover:shadow-[0_14px_36px_rgba(26,109,204,0.28)] transition"
              style={{
                background: "linear-gradient(135deg, #144073, #1A6DCC)",
              }}
            >
              {lang === "uk" ? "Приєднайтесь до нас" : "Join us"}
            </a>
          </div>
        </div>
      </div>
